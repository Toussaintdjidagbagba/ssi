          ...
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">ENVOYER RECU LONGRICH</h1>
              </div>
              ...
              <form class="user" method="post" action="{{ route('longrichrecuS') }}"> 
                {{ csrf_field() }}
              
                <div class="form-group">
                  <label>Référence du recu LONGRICH SSI : </label>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <label>Date :</label>
                    <input type="text" class="form-control " name="dateL" value="{{ $demande->dateL }}" disabled="true">
                    <input type="hidden" class="form-control " name="dateL" value="{{ $demande->dateL }}">
                  </div>
                </div> 
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" class="form-control" name="libelle" value="INSCRIPTION LONGRICH" disabled="true">
                    <input type="hidden" class="form-control" name="libelle" value="INSCRIPTION LONGRICH">
