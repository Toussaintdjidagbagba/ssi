          ...
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">ENVOYER RECU SBEE CONVENTIONEL</h1>
              </div>
              ...
              <form class="user" method="post" action="{{ route('sbeeconventionnelrecuS') }}"> 
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" class="form-control" name="libelle" value="SBEE : COMPTEUR CONVENTIONNEL" disabled="true">
                    <input type="hidden" class="form-control" name="libelle" value="SBEE : COMPTEUR CONVENTIONNEL">
