                        ...
                        <table class="table table-hover">
                            ...
                            @forelse($demandes as $demande)
                              <tr>
                                ...
                                <td>{{ $demande->date }}</td>
                                <td> <a href="/sbeeconventionnel-recu:reference-{{ $demande->RefRecu }}"><i class="material-icons">done</i></a> </td>
                                <td>
                                ...
                                <td>
                                  <a class="" 
                                        ...
                                        href="{{url('admin/delete-sbeeconventionnel-'.$demande->RefRecu)}}">
