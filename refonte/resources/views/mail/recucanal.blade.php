		...
		<div style="max-width: 650px; width: 500px; margin: 0 auto; padding: 20px; background: #fff;">
			<table>
						<tr style="border: 1px solid white;">
							...
							<td style=" width: 20%">
								<img src="https://sourcedusuccesinternational.com/img/canal.jpg" style="width: 100px; height: 120px; margin-top: -80px">
							</td>
			...
			<div style="background-image: ; margin-top: 20px; max-height: 600px; height: 350px; width: 100%">
				...
				<div style="text-align: center;">
					<table style="border: 1px solid black;">
						<tr style="border: 1px solid black; color: #25599C">
							<td style="border: 1px solid blue;">FORMULE </td>
							<td style="border: 1px solid blue;">No FACTURE</td>
							<td style="border: 1px solid blue;" >MONTANT FACTURE</td>
							<td style="border: 1px solid blue;">DATE ESPIRE</td>
							<td style="border: 1px solid blue;">TOTAL ENCAISSER</td>
						</tr>
						<tr style="border: 1px solid black;">
							<td style="border: 1px solid black;"> {{$Choisirformule}}</td>
							<td style="border: 1px solid black;"> {{$reglementnum}}</td>
							<td style="border: 1px solid black;"> {{$montant}} $ SSI <br> 
                            {{$montantf}} F CFA </td>
							<td style="border: 1px solid black;"> {{$dateespire}}</td>
							<td style="border: 1px solid black;" > {{$totale}} $ SSI <br> 
                            {{$totalef}} F CFA</td>
						</tr>
					</table>
				...
				<div>
					<br>
					Durée de l'abonnement : {{ $Dureenmois }} mois <br>
					No QUITTANCE : {{ $reglementnum }} <br>
