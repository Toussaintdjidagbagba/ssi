  ...
  @if(isset($non))
    <div class="row"> 
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          <li><i class="fa fa-home">Vous n'être pas encore à l'étape 5 </i></li>
        </ol>
      </div>
    </div>
      ...
      <table>
        <tr>
          <td id="lag">
            ...
            @if($ouf[4]->PositionGauche <> "A")
              @foreach($mesfilleuls as $filleul)
                @if($filleul->codeperso == $ouf[4]->PositionGauche)
          ...
          <td id="lag">
            @if($ouf[4]->PositionDroite <> "A")
            @foreach($mesfilleuls as $filleul)
              @if($filleul->codeperso == $ouf[4]->PositionDroite)
                  <center> {{ $filleul->nomuser }} ( {{ $filleul->codeperso }} ) <br> {{ $filleul->email }} <br> || <br> ||</center>
              @endif
            @endforeach
            @else
