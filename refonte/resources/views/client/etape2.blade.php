      ...
      <table>
        <tr>
          <td id="lag">
            ...
            @if($ouf[1]->PositionGauche <> "A")
              @foreach($mesfilleuls as $filleul)
                @if($filleul->codeperso == $ouf[1]->PositionGauche)
          ...
          <td id="lag">
            @if($ouf[1]->PositionDroite <> "A")
            @foreach($mesfilleuls as $filleul)
              @if($filleul->codeperso == $ouf[1]->PositionDroite)
                  <center> {{ $filleul->nomuser }} ( {{ $filleul->codeperso }} ) <br> {{ $filleul->email }} <br> || <br> ||</center>
              @endif
            @endforeach
            @else
