          ...
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">ENVOYER RECU PERFECT MONEY</h1>
              </div>
              ...
              <form class="user" method="post" action="{{ route('perfectrecuS') }}"> 
                {{ csrf_field() }}
              
                <div class="form-group">
                  <label>Référence du recu PERFECT MONEY SSI : </label>
