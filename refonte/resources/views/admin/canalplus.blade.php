                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="{{ route('canalplusS') }}">
                    ...
                    <div class="form-group">
                      <label>Nom d'abonné :</label>
                      <input id="input" type="text" class="form-control form-control-user" placeholder="Entrez nom abonné :" name="nom">
                      @if($errors->has('nom'))
                     ...
                     <div class="form-group">
                     <label>Prénom d'abonné :</label> 
                      <input id="input" type="text"  class="form-control form-control-user"  placeholder="Entrez prénom abonné :" name="prenom">
                      @if($errors->has('prenom'))
                        <p style="color: red"> Saisissez votre prénom</p>
                      @endif
                    </div>
                    
                    <div class="form-group">
                     <label>Numéro d'abonné :</label> 
                      <input id="input" type="number"  class="form-control form-control-user"  placeholder="Entrez numéro abonné :" name="numero">
                      @if($errors->has('numero'))
                        <p style="color: red"> Saisissez votre numéro</p>
                      @endif
                    </div>
                    
                    <div class="form-group">
                      <label>Numero carte ou abonné :</label>
                      <input id="input" type="number" class="form-control form-control-user"  placeholder="Entrez votre numéro carte ou abonné" name="num" >
                      @if($errors->has('num'))
                     ...
                     <div class="form-group">
                      <select type="text" class="form-control"  name="formule" id="input" placeholder="Entrer votre formule" data-original-title="Entrer votre formule">
                        ...
                        <option value="essentiel"> essentiel + [24 $ SSI] (12000 FCFA) </option>
                    ...
                    <div class="form-group">
                     <label>Observation :</label> 
                      <input id="input" type="text"  class="form-control form-control-user"  placeholder=" Spécifier lorsqu'il s'agit de réabonnement " name="observation">
                    </div>    
