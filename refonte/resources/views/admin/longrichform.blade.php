      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            ...
            <div class="subheading">LONGRICH</div>
          </div>
        </div>
      </div>
    </div> 
              ...
              <div class="col-lg-8">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    ...
                    <h1 class="h4 text-gray-900 mb-4">Achat de produit de consmétique et de santé</h1>
                  </div>
                  <form class="user" method="post" action="{{ route('longrichformS') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      @if($errors->has('nais'))
                        <p style="color: red"> Saisissez votre date de naissance</p>
                      @endif
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      @if($errors->has('tel'))
                        <p style="color: red"> Saisissez votre téléphone</p>
                      @endif
                    </div>
