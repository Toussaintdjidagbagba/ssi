<nav class="navbar" style="background-color: skins green !important;">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <!--logo start-->
              <a href="<?php echo e(route('index')); ?>" class="navbar-brand" ><img src="<?php echo e(asset('img/logo_ssi.png')); ?>" style="height: 60px; margin-top: -17px; width: 170px" /></a>
            <!--logo end-->
        </div>
        <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            <!-- <li class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                <?php echo e(Auth::user()->prenom); ?> <?php echo e(Auth::user()->nom); ?> ( <?php echo e(Auth::user()->codeperso); ?> )
                <b class="caret"></b>
                </a>
                <ul class="dropdown-menu">
                    ...
                    <li class="eborder-top">
                      <a href="<?php echo e(route('profiladmin')); ?>"><i class="icon_profile"></i> Mon Profil</a>
                    </li>
