...
class UtilisateurController extends Controller
{
    ...
    public static function reinitialiseruser(Request $request){
        if (!in_array("reset_user", session("auto_action"))) {
            ...
            //$pwd = "BossduSucces2807#€&@92";
           Users::where('idUser', request('id'))->update(['password' =>  "com".sha1($pwd)."dste"]);
           $user = Users::where('idUser', request('id'))->first();
           $messa = "Votre nouveau mot de passe : ".$pwd;
           SendMail::sendmailnotification($user->mail, "Réinitialisation de mot de passe admin", $messa, "Mot de passe réinitialisé : ");
