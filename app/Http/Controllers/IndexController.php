...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        flash("Des travaux de maintenance seront réalisés de 23h à 6h sur la plateforme. Toutes nos excuses pour les désagréments causés par ce fait. Merci."); 
...
Pour des raisons de maintenance la plateforme SSI a connaitra quelques dysfonctionnement cette semaine
...
Merci pour la commande");
    ...
    public function clientdashboard()
    {
        ...
        if ($type == "client") {
            $gains = DB::table('avoirs')->select('gainvirtuel', 'gainespece', 'gaincommissionvente', 'compv', 'id_user')->where('id_user', auth()->user()->id)->get();
        ...
        if ($type == "admin") {
            ...
            $notifvisas =  DB::table('retraitvisas')->select(DB::raw('count(statut) as attente'))->where('statut', '!=', '0')->where('Statut', '!=', 'sup')->get()[0]->attente;
            // SERVICES
