...
class CreateSbeecartesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sbeecartes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sbeecartes');
    }
}
