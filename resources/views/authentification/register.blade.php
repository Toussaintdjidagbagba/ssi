        ...
        <div class="row" style="background-color: rgba(255, 255, 255, 0.5);">
          ...
          <div class="col-xl-8 col-lg-8 col-md-10 col-sm-10 col-xs-10  col-xl-offset-2 col-lg-offset-2 col-md-offset-1 col-xs-offset-1 col-sm-offset-1 at-itemt">
            <div class="p-5">
              ...
              <form class="user at-itemt" method="post" action="{{ route('inscriptionS') }}" enctype="multipart/form-data">
                {{ csrf_field() }}

                <!-- Pseudo -->
                <div class="form-group">
                  <label>Pseudo ou nom d'entreprise<i style="color: red">*</i></label>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select type="text" class="form-control"  name="pays" id="input" placeholder="Entrer votre Pays" data-original-title="Entrer votre Pays">
                        <option>Bénin</option>
                        @foreach($pays as $pay)
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="number" class="form-control " name="tel" id="input" placeholder="Entrer votre téléphone" data-original-title="Entrer votre téléphone">
                    @if($errors->has('tel'))
                ...
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <label>Code sponsor <i style="color: red">*</i></label>
                    <input type="text" class="form-control" name="parrain" id="input" placeholder="Code de sponsor" data-original-title="Entrer code sponsor" /> 
                    <div class="form-check">
                      <input type="checkbox" class="form-check-input" id="input" name="cocherparrain" value="Pas de code de sponsor.">
                      <label class="form-check-label" for="parain">Pas de code sponsor.</label>
                    </div>
                  </div>
                  <!--div class="col-sm-6">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <!-- Requete pour pays de la base de donnees--> 
                    <label>Pièce d'identité <i style="color: red">*</i></label>
                    <select type="text" class="form-control" name="ide" id="input" >
                      <option>Carte d'identité national</option>
                      <option>Passport</option>
                    </select>  
                  </div>
                  <!-- Education financière -->
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>Numéro de la pièce d'identité <i style="color: red">*</i></label>
                  <input type="text" class="form-control" name="numpie"  id="input" >
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <!-- Requete pour pays de la base de donnees--> 
                    <label>Photo de la pièce d'identité <i style="color: red">*</i></label><br> Cliquez sur l'image pour importer <br>
                    <img class="profile-image" id="photopiece" src="photo/carte.png" style="border-radius: 10%; width:250px; height:200px" >
                    <input type="file" class="form-control" name="photopiece"  id="photopieceinput" hidden accept=".png, .jpeg, .jpg" style="display:none" >
                  </div>
                  <!-- Education financière -->
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>Votre photo d'identité<i style="color: red">*</i></label> <br> Cliquez sur l'image pour importer <br>
                    <img class="profile-image" id="photo" src="photo/deadd.png" style="border-radius: 50%; width:150px; height:150px" >
                    <input type="file" class="form-control" name="photo"  id="photoinput" hidden accept=".png, .jpeg, .jpg" style="display:none" >
...
@section('js')
    ...
    <script type="text/javascript">
		...
		const input = document.getElementById("photopieceinput")
		const pick = document.querySelector("#photopiece")
		...
		input.addEventListener('change', () => {
			...
			const preview = document.getElementById("photopiece")
		...
		const inputi = document.getElementById("photoinput")
		const picki = document.querySelector("#photo")
