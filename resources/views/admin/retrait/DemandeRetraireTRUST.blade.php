                        ...
                        <table class="table table-hover">
                            ...
                            @forelse($demandes as $demande)
                              <tr>
                                ...
                                <td> 
                                  <button type="button" title="Reçu" class="btn btn-warning btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('trust', $demande->reff) }}" style="color:white;"> 
                                  ...
                                  <button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('deleteTrust',$demande->reff)}}" style="color:white;"><i class="material-icons">delete_sweep</i></a> </button>
