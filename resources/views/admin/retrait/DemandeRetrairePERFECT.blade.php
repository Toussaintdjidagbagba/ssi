        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                      <h2>
                      Liste des demandes de retraire sur PERFECT MONEY
                      </h2>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            @forelse($demandes as $demande)
                              <tr>
                                ...
                                <td>
                                  <button type="button" title="Reçu" class="btn btn-warning btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('perfectrecu', $demande->reff) }}" style="color:white;">
                                  ...
                                  <button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('deleteperfect',$demande->reff)}}" style="color:white;"><i class="material-icons">delete_sweep</i></a> </button>
