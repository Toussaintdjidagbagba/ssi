        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                      <h2>
                      Liste des demandes de retraire sur WESTERN UNION
                      </h2>
                    </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                  ...
                                  <th><i class="icon_pin_alt"></i> Nom & Prenom </th>
                                  <th><i class="icon_pin_alt"></i> Adresse <br>& Ville <br>& Pays </th>
                            ...
                            @forelse($demandes as $demande)
                              <tr>
                                ...
                                <td>{{ $demande->adresse }} <br>{{ $demande->ville }} <br>{{ $demande->pays }}</td>
                                <td> {{ $demande->motif }}</td>
                                ...
                                <td>
                                  <button type="button" title="Reçu" class="btn btn-warning btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('westernrecu', $demande->reff) }}" style="color:white;"> 
                                  ...
                                  <button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('deletewestern',$demande->reff)}}" style="color:white;"><i class="material-icons">delete_sweep</i></a> </button>
