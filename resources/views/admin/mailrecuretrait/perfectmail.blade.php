		...
		<div style="max-width: 650px; width: 500px; margin: 0 auto; padding: 20px; background: #fff;">
			<table>
						<tr style="border: 1px solid white;">
							...
							<td style=" width: 20%">
								<img src="https://sourcedusuccesinternational.com/img/perfect.png" style="width: 100px; height: 120px; margin-top: -80px">
							</td>
					...
					<table>
						<tr style="border: 1px solid white;">
							<td style="text-align: left; width: 50%; font-size: 16px; text-align: justify;text-justify: auto;">
								...
								{{$datevalider}} de votre compte pour {{$intituler}}  via le lien {{$lien}}.
