            ...
            <div class="card">
                ...
                <div class="body">
                  ...
                  @include('flash::message')
                    ...
                    <form class="user trna" method="post" style="border: 0.5px solid gray; padding: 20px" action="{{ route('transfertgainvirtuelS') }}">
                    {{ csrf_field() }}    
                        ...
                        <div class="form-group">
                            <div class="form-line">
                            <input type="number" class="form-control form-control-user otp"  placeholder="Entrez le code" name="otp" >
                            </div>
                            @if($errors->has('otp'))
