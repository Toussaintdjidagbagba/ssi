            ...
            <div class="card">
                ...
                <div class="body">
                  ...
                  @include('flash::message')
                    ...
                    <form  class="user trna" style="border: 0.5px solid gray; padding: 20px" method="post" action="{{ route('transfertadminS') }}">
                    {{ csrf_field() }}    
                        ...
                        <!-- style="display: none" dans otp
                        <div class="form-group">
                            <div class="col-md-12">
                              <button class="btn btn-user " id="butc">
                                <a href="#" id="code"> CONFIRMER</a>
                              </button>
                              
                              <button class="btn btn-user " id="buvt" style="display: none" >
                                <a href="#" id="codev"> OUI</a>
                              </button>
                              
                              <button class="btn btn-user " id="butf" style="display: none">
                                <a href="#" id="codef"> NON</a>
                              </button>
                            </div>
                        </div>
                        <div class="row clearfix"> 
                        ...
                        <div class="col-sm-12">
                        <div class="form-group">
                            <!--a class=" identifyingeqp btn  btn-user btn-primary m-l-15 m-t-15 waves-effect" id="but" href="#add" data-target="#add" 
                            data-toggle="modal" data-id="1comp" title="TRANSFERER">TRANSFERER</a
