          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
            			<form class="user" method="post" action="{{ route('celttisS') }}">
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de crédit Celtiis</h4>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de Forfait internet Celtiis </h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
            		...
            		<div class="modal-body" style="text-align: left;">
	                    ...
	                    <div class="form-group">
	                      <select id="input" type="number" class="form-control"  name="forfaitlib" placeholder="Forfait Appel" data-original-title="Entrer le module du forfait">
	                        ...
	                        <option value="3">1.5 SSI (72h)</option>
	                        <option value="4">2 SSI (07jrs)</option>
	                        <option value="5">3 SSI (07jrs)</option>
	                        <option value="6">4 SSI (07jrs)</option>
	                        <option value="8">6 SSI (30jrs)</option>
	                        <option value="9">10 SSI (30jrs)</option>
	                        <option value="10">20 SSI (30jrs)</option>
	                    </select>
	                  </div>
            		</div>
            		<div class="modal-footer" >
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de forfait Appel Celtiis </h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
            		...
            		<div class="modal-body" style="text-align: left;">
                        ...
                        <div class="form-group">
                          <select id="input" type="text" class="form-control"  name="forfaitlib" placeholder="Forfait MAXI" data-original-title="Entrer le module du forfait">
                            <option value="1">0.4 SSI (24h)</option>
							<option value="2">0.6 SSI (24h)</option>
                            <option value="3">1 SSI (07jrs)</option>
                            <option value="4">2 SSI (07jrs)</option>
                            <option value="5">3 SSI (07jrs)</option>
		                    <option value="6">4 SSI (07jrs)</option>
		                    <option value="7">6 SSI (30jrs)</option>
		                    <option value="8">10 SSI (30jrs)</option>
		                    <option value="9">14 SSI (30jrs)</option>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de Forfait Maxi appel et internet MTN </h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Dépôt sur compte Celtiis  </h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Dépôt sur compte MTN  </h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
            		</div>
            		<div class="modal-body" style="text-align: left;">
