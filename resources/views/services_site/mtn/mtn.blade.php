          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de crédit MTN </h4>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de Forfait internet MTN</h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
            		...
            		<div class="modal-body" style="text-align: left;">
	                    ...
	                    <div class="form-group">
	                      <select id="input" type="number" class="form-control"  name="forfaitlib" placeholder="Forfait Appel" data-original-title="Entrer le module du forfait">
	                        ...
	                        <option value="2">1.99 SSI (72h)</option>
	                        ...
	                        <option value="14">40 SSI (illimité)</option>
                            <option value="15">50 SSI (illimité)</option>
                            <option value="16">60 SSI (illimité)</option>
                            <option value="17">100 SSI (illimité)</option>
                            <option value="18">150 SSI (illimité)</option>
	                    </select>
	                  </div>
            		</div>
            		<div class="modal-footer" >
          ...
          <div class="modal-dialog">
            <div class="modal-content">
            		<div class="modal-header" style="text-align: left; background-color: #5ca945;">
	                    ...
	                    {{ csrf_field() }}
            			<div class="modal-header" style="text-align: left; background-color: #5ca945;">
		                <h4 class="modal-title" style="color : #fff">Achat de forfait maxi appel MTN</h4>
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		              </div>
