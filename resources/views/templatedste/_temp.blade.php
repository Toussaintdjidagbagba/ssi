        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">{{ session('utilisateur')->mail }}</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="{{ route('GR') }}"><i class="large material-icons col-light-green">insert_chart</i><span>Rôle</span></a></li>
                    <li><a href="{{ route('GU') }}"><i class="large material-icons col-light-green">insert_chart</i><span>Utilisateurs</span></a></li>
                    <li><a href="{{ route('GM') }}"><i class="large material-icons col-light-green">insert_chart</i><span>Menu</span></a></li>
