      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                <div class="header">
                    <h2>
                    Liste des demandes facture conventionnel SBEE
                        ...
                        <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                            ...
                            @forelse($demandes as $demande)
                              <tr>
                                ...
                                <td>{{ $demande->Police }} / {{ $demande->Presentation }}</td>
                                ...
                                <td>
                                  <button type="button" title="Reçu"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                    <a href="{{ route('sbeeconventionnelrecu', $demande->RefRecu)}}" style="color:white;"> <i class="material-icons">assignment</i></a> 
                                  </button>
                                  ...
                                  <button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('deleteCon',$demande->RefRecu)}}" style="color:white;"><i class="material-icons">delete_sweep</i></a> </button>
