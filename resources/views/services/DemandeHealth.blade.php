        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                      <h2>
                      Liste des demandes d'inscription H & W
                      </h2>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            @forelse($demandes as $demande)
                              <tr>
                                ...
                                <td>{{ $demande->dateH }} <br> {{ $demande->pays }} </td>
                                <td>{{ $demande->MontantPayer }}</td>
                                <td>{{ $demande->date }}</td>
                                <td> <a href="/health-recu:reference-{{ $demande->RefRecu }}"><i class="material-icons">done</i></a> </td>
                                <td>
