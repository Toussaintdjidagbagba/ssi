                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                      <div class="row">    
                                        <div class="col-lg-12">
                                          <h3 class="page-header">Achat SSI</h3>
            ...
            <div class="row">
              ...
              <div class="col-lg-8"> 
                <div class="p-5">
                  ...
                  <br>
                  <form class="user trna" method="post" action="{{ route('saspv') }}">
                    {{ csrf_field() }}
                     
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user ident" required placeholder="Entrez identifiant du distributeur" name="id">
                      @if($errors->has('id'))
                    ...
                    <div class="form-group">
                      <select type="number" class="form-control form-control-user typ" required placeholder="Entrez la référence" name="typ">
                          <option value="0">Compte Virtuel</option>
                          <option value="1">Compte espèce</option>
                      </select>
                    </div>
                    
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user ref" required placeholder="Entrez la référence" name="ref">
                      @if($errors->has('id'))
                        <p style="color: red"> {{ $errors->first('id') }}</p>
                      @endif
                    </div>
                    ...
                    <a class="btn btn-user btn-block" href="#" style="background: #4f2e14; color:white; display : none" id="boutonT"><b>CONFIRMER LA DEMANDE D'ACHAT</b></a>
            ...
            x.addEventListener("click", function () {
              ...
              if(ident == "" || (mont == "" ))
                document.getElementById("data").innerHTML = "<b style='color:red'>Veuillez remplir tous les champs..</b>";
                  ...
                  var xhr = getXMLHttpRequest(); 
                  xhr.open("GET", "{{route('setcheckpv')}}?pseudo="+ident+"&service=achat", true);
                  xhr.send(null);
                  xhr.onreadystatechange = function() {
                      if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0)) {
                          if(xhr.responseText == 1){
                              ...
                              if(xhr.responseText == 2){
                                  ...
                                  if(xhr.responseText == 7){
                                    document.getElementById("data").innerHTML = "Ce identifiant n'est pas un distributeur.";
                                    document.getElementById("boutonA").style.display="block";
                                  }else{
