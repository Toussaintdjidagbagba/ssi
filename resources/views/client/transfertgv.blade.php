                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                      <div class="row">    
                                        <div class="col-lg-12">
                                          <h3 class="page-header">Vendre (Gain virtuel)</h3>
            ...
            <div class="row">
              ...
              <div class="col-lg-8"> 
                <div class="p-5">
                  ...
                  <br>
                  <form class="user trna" method="post" action="{{ route('transfertgvS') }}">
                    {{ csrf_field() }}
                     
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user ident" required placeholder="Entrez identifiant du destinataire" name="id">
                      @if($errors->has('id'))
            ...
            y.addEventListener("click", function () {
              ...
              xhr.onreadystatechange = function() {
                  if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0)) {
                      readData(xhr.responseText); // Donnï¿½es textuelles rï¿½cupï¿½rï¿½es
                  }
              };
            }, true);             
