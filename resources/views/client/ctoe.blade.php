                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                      <div class="row">    
                                        <div class="col-lg-12">
                                          <h3 class="page-header">Transfert de commission sur vente sur gain espèce</h3>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-lg-8"> 
                                                  <div class="p-5">
                                                    ...
                                                    <form class="user" method="post" action="{{ route('cteS') }}">
                                                      {{ csrf_field() }}
                                                      ...
                                                      <div class="form-group">
                                                        <button class="btn  .hor-grd .btn-grd-* .btn-out-dotted btn-user" >
                                                          <a href="#" id="code"> Générer code OPT</a>
                                                        </button>
                                                      </div>
                                                      
                                                      <button type="submit" class="btn  .hor-grd .btn-grd-2 .btn-out-dotted btn-user btn-block">
                                                        <b>TRANSFERER</b>
                                                      </button>
