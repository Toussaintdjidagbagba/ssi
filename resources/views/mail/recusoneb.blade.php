		...
		<div style="max-width: 650px; width: 500px; margin: 0 auto; padding: 20px; background: #fff;">
			<table>
						<tr style="border: 1px solid white;">
							...
							<td style=" width: 20%">
								<img src="https://sourcedusuccesinternational.com/img/soneb.jpg" style="width: 100px; height: 120px; margin-top: -80px">
							</td>
				...
				<div style="text-align: center;">
					<table style="border: 1px solid black;">
						<tr style="border: 1px solid black; color: #25599C">
							<td style="border: 1px solid blue;">PERIODE FACTURE</td>
						...
						<tr style="border: 1px solid black;">
							...
							<td style="border: 1px solid black;">  {{$FraisSSI }}  $ SSI <br> 
                             {{$FraisSSIf}}  F CFA</td>
