				...
				<div class="body">
					...
					<form class="form-horizontal" method="post" action="{{ route('MenuAttr') }}" >
						...
						<div class="form-group" style="display: block;" >
							<div class="col-sm-12">
								<button type="submit" data-color="deep-orange" class=" btn-sm bg-deep-orange waves-effect waves-light" style="float:right; margin-top: 20px; margin-left: 15px; width: 25%;">Attribuer
								</button>
							</div>
						</div>
					</form>	
